...
//        Employee: Jeremy , Smith
        ...
        System.out.println(employeeJakub.getEmail().getEmail()); //Jakub.Nowak@DEVELOPERS.com

        employeeManagementService.changeEmail(employeeJakub, "new.email@test.com");

        System.out.println(employeeJakub.getEmail().getEmail()); //new.email@test.com
...
//        Employee: Jeremy , Smith
        ...
        System.out.println(employeeJeremy.getLastEmailMessage().getFrom().getEmail().getEmail()); //Adam.Klak@MANAGEMENT.com
